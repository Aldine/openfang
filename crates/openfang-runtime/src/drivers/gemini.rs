...
mod tests {
    ...
    #[test]
    fn test_function_call_response_yields_tool_call() {
        let json = serde_json::json!({
            "candidates": [{
                "content": {
                    "role": "model",
    ...
    #[test]
    fn test_text_response_produces_text_block() {
        let json = serde_json::json!({
            "candidates": [{
                "content": {
                    "role": "model",
    ...
    #[test]
    fn test_convert_messages_tool_use_serializes_function_call() {
        let messages = vec![
    ...
    #[test]
    fn test_function_call_thought_signature_round_trip() {
        ...
        match deserialized {
            GeminiPart::FunctionCall { function_call } => {
                assert_eq!(function_call.thought_signature.as_deref(), Some("my_sig_abc"));
            }
    ...
    #[test]
    fn test_text_part_still_deserializes() {
